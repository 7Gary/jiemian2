...
class DetectThread(QThread):
    ...
    def run(self):
        ...
        try:
            ...
            score = float(data.get("raw_score", 0.0))
...
class ZhijianWindow(QWidget):
    def __init__(self):
        ...
        self.image_dir = (r"D:\Downloads\patchcore-inspection-main\datasets\mvtec_anomaly_detection\mvtec_anomaly_detection\user3\test\bad"
                          r"")
    ...
    def resizeEvent(self, event):
        ...
        # 顶部灰条 frame - 保持高度51，宽度自适应，左右各留30/70边距
        self.ui.frame.setGeometry(30, 0, w - 100, 51)
        
        # 大背景 textBrowser - 几乎占满整个背景
        self.ui.textBrowser.setGeometry(50, 50, w - 140, h - 58)
        
        # 参数区域 frame_2 - 保持高度101，宽度自适应
        frame2_width = w - 160
        self.ui.frame_2.setGeometry(60, 60, frame2_width, 101)
        
        # frame_2 内部控件需要根据 frame_2 的宽度调整
        # 右侧按钮区域相对于 frame_2 右边对齐
        btn_right_offset = frame2_width - 400  # 按钮区域从右边数起的位置
        self.ui.label_10.setGeometry(btn_right_offset, 10, 91, 21)
        self.ui.label_18.setGeometry(btn_right_offset + 10, 40, 71, 51)
        self.ui.label_13.setGeometry(btn_right_offset + 100, 10, 81, 81)
        self.ui.label_15.setGeometry(btn_right_offset + 210, 10, 81, 81)
        self.ui.label_14.setGeometry(btn_right_offset + 320, 10, 81, 81)
        
        # 左侧信息框 textBrowser_2 - 固定宽度401，高度自适应
        left_info_height = h - 188
        self.ui.textBrowser_2.setGeometry(60, 170, 401, left_info_height)
        
        # 图片显示区域 imageLabel - 占据右侧主要空间
        image_width = w - 570
        image_height = h - 259
        self.ui.imageLabel.setGeometry(470, 170, image_width, image_height)
        
        # 底部两个结果按钮 - 相对于底部对齐，水平居中偏左
        btn_y = h - 79
        center_x = w // 2
        self.ui.label_16.setGeometry(center_x - 221, btn_y, 121, 41)
        self.ui.label_17.setGeometry(center_x - 21, btn_y, 121, 41)
